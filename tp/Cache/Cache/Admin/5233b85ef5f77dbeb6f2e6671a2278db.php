...
<head>
	...
	<script>
	var URL = '/index.php/Admin/MaterialType';
	var SELF = 'http://admin.leishenhuyu.com/index.php?m=&c=MaterialType&a=index&menuid=65';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10">
    ...
    <div class="textbox">
        <div class="picbox" role="table">
            <div class="J_tablelist table_list" data-acturi="<?php echo U('MaterialType/ajax_edit');?>">
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="40"><input type="checkbox" name="checkall" class="J_checkall"></th>
                            <th width="40"><?php echo L('type_id');?></th>
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            <td align="center"><input type="checkbox" class="J_checkitem" value="<?php echo ($val["type_id"]); ?>"></td>
                            <td align="center"><?php echo ($val["type_id"]); ?></td>
                            <td align="center"><?php echo ($val["type_name"]); ?></td>
                        <td align="center">
                            <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('MaterialType/edit', array('type_id'=>$val['type_id'],'menuid'=>$menuid));?>" data-title="<?php echo L('edit');?> - <?php echo ($val['type_name']); ?>" data-id="edit" data-width="400" data-height="200"><?php echo L('edit');?></a> |
                            <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('MaterialType/delete', array('type_id'=>$val['type_id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['type_name']);?>"><?php echo L('delete');?></a>
                        </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('MaterialType/delete');?>" data-name="game_id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
