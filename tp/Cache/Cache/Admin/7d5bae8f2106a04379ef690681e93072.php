...
<head>
	...
	var SELF = 'http://admin.leishenhuyu.com/index.php?m=&c=admin&a=index&menuid=8';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
                ...
                <tr>
                    <td>
                        <div class="explain_col">
                            ...
                            &nbsp;&nbsp;管理员账号 :
                            <input type="text" name="username" id="username" value="<?php echo ($search["username"]); ?>" style="width:155px;height:20px;">
                            &nbsp;&nbsp;真实姓名:
                            <input type="text" name="realname" id="realname" value="<?php echo ($search["realname"]); ?>" style="width:155px;height:20px;">
        ...
        <table width="100%" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th><?php echo L('admin_realname');?></th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="center"><?php echo ($val["rolename"]); ?></td>
                    <td align="center"><?php echo (date('Y-m-d H:i:s',$val["last_time"])); ?></td>
                    <td align="center"><?php echo ($val["last_ip"]); ?></td>
                    <td align="center">
                <img data-tdtype="toggle" data-field="status" data-id="<?php echo ($val["id"]); ?>" data-value="<?php echo ($val["status"]); ?>" src="/Public/images/admin/toggle_<?php if($val["status"] == 0): ?>disabled<?php else: ?>enabled<?php endif; ?>.gif" />
                </td>
                <td align="center">
