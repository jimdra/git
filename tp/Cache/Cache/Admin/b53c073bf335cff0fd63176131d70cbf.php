...
<head>
	...
	var SELF = '/index.php?m=&c=GameNotice&a=scroll&menuid=35';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10">
    ...
    <div class="J_tablelist table_list">
        <table width="100%" cellspacing="0" id="scl_tt2" style="height:500px;">
            <thead>
                <tr>
                    <th data-options="field:'server_name',width:150,align:'center'"><?php echo L('server_name');?></th>
                    <th data-options="field:'start_time',width:150,align:'center'"><?php echo L('notice_start_time');?></th>
                    <th data-options="field:'end_time',width:150,align:'center'"><?php echo L('notice_end_time');?></th>
                    <th data-options="field:'step',width:80,align:'center'"><?php echo L('notice_step');?></th>
                    <th data-options="field:'count',width:80,align:'center'"><?php echo L('notice_count');?></th>
                    <th data-options="field:'content',width:200,align:'center'"><?php echo L('notice_content');?></th>
                    <th data-options="field:'release_user',width:150,align:'center'"><?php echo L('release_user');?></th>
                    <th data-options="field:'release_time',width:150,align:'center'"><?php echo L('release_time');?></th>
                    <th data-options="field:'review_user',width:80,align:'center'"><?php echo L('review_user');?></th>
                    <th data-options="field:'review_time',width:150,align:'center'"><?php echo L('review_time');?></th>
                    <th data-options="field:'status',width:150,align:'center'"><?php echo L('status');?></th>
                    <th data-options="field:'opt',width:150,align:'center',formatter:formatOper"><?php echo L('opt');?></th>
                </tr>
            </thead>
        </table>
    </div>
...
$(function(){
    ...
    $('#scl_tt2').datagrid({
            singleSelect:true,
            nowrap:true,
            url:'<?php echo U("GameNotice/scroll");?>',
            fitColumns:true,
            nowrap:true,
            pagination:true,  //分页
            pageSize: 100,
...
function formatOper(val,row,index){
    var html = '<a href="javascript:;" onclick="showDialog(this);"  data-uri="index.php?m=Admin&c=GameNotice&a=edit_scroll&id='+row.id+'" data-title="'+row.server_name+'"  data-id="edit" data-width="450" data-height="210"><?php echo L('edit');?></a> ';
    html += ' | <a href="javascript:;" onclick="confirmUrl(this);"  data-uri="index.php?m=Admin&c=GameNotice&a=review&id='+row.id+'" data-title="'+row.server_name+'"  data-id="edit" data-msg="确认审核发送"><?php echo L('review');?></a> ';
    return html;
}
