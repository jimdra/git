...
<head>
	...
	<script>
	var URL = '/index.php/Admin/Game';
	var SELF = 'http://admin.leishenhuyu.com/index.php?m=&c=Game&a=index&menuid=52';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10">
    ...
    <div class="textbox">
        <div class="picbox" role="table">
            <div class="J_tablelist table_list" data-acturi="<?php echo U('Game/ajax_edit');?>">
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="40"><input type="checkbox" name="checkall" class="J_checkall"></th>
                            <th width="40"><?php echo L('game_id');?></th>
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            <td align="center"><input type="checkbox" class="J_checkitem" value="<?php echo ($val["game_id"]); ?>"></td>
                            <td align="center"><?php echo ($val["game_id"]); ?></td>
                            <td align="center"><?php echo ($val["game_name"]); ?></td>
                            <td align="center"><?php echo ($val["game_code"]); ?></td>
                        <td align="center">
                            <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('Game/edit', array('game_id'=>$val['game_id'],'menuid'=>$menuid));?>" data-title="<?php echo L('edit');?> - <?php echo ($val['game_name']); ?>" data-id="edit" data-width="400" data-height="200"><?php echo L('edit');?></a> |
                            <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('Game/delete', array('game_id'=>$val['game_id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['game_name']);?>"><?php echo L('delete');?></a>
                        </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('Game/delete');?>" data-name="game_id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
