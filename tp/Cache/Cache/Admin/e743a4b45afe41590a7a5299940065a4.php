...
<div class="dialog_content">
    ...
    <table width="100%" class="table_form">
        ...
        <tr>
          ...
          <td>
            <label><input type="radio" name="iframe" class="radio_style" value="1" <?php if($info["iframe"] == 1): ?>checked="checked"<?php endif; ?> onchange="javascript:change_iframe(this.value);"> <?php echo L('yes');?>&nbsp;&nbsp;</label>
            <label><input type="radio" name="iframe" class="radio_style" value="0" <?php if($info["iframe"] == 0): ?>checked="checked"<?php endif; ?>  onchange="javascript:change_iframe(this.value);"> <?php echo L('no');?></label>
          </td>
        </tr>
        <tr id="iframeWidth" style="display: none">
          <th><?php echo L('menu_iframe_width');?> :</th>
          <td><input type="text" name="iframeWidth" id="iframeWidth" class="input-text" value="<?php echo ($info["iframeWidth"]); ?>"></td>
        </tr>
        <tr id="iframeHeight" style="display: none">
          <th><?php echo L('menu_iframe_height');?> :</th>
          <td><input type="text" name="iframeHeight" id="iframeHeight" class="input-text" value="<?php echo ($info["iframeHeight"]); ?>"></td>
        </tr>
    </table>
