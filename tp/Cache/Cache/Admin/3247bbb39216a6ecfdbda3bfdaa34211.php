...
<head>
	...
	var SELF = 'http://admin.leishenhuyu.com/index.php?m=&c=Ad&a=index&menuid=70';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
            ...
            <div class="J_tablelist table_list" data-acturi="<?php echo U('Ad/ajax_edit');?>">
                <table width="100%" cellspacing="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td align="center">
                            <a href="<?php echo U('Ad/edit',array('id'=>$val['id'],'menuid'=>$menuid));?>"><?php echo L('edit');?></a> |
                            <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('Ad/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['id']);?>"><?php echo L('delete');?></a>
                        </td>
