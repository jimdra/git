...
<head>
	...
	var SELF = '/index.php?m=&c=Goods&a=specified&menuid=29';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="dialog_content" style="margin: 20px">
    <form name="info_form" id="info_form" action="<?php echo U('Goods/specified');?>" method="post" onsubmit="return check();">
        <table width="100%" class="table_form">
            <tr>
                <th width="80"><?php echo L('choose_game');?> :</th>
                <td>
                    <select class="searCom" name="platform_id" id="PlatformID"></select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><textarea name="player_info" id="player_info" cols="30" rows="3"></textarea>多个用英文模式逗号隔开(101,102)</td>
            </tr>
            <tr>
