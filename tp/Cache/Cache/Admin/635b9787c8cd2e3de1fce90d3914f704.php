...
<head>
	...
	var SELF = '/tp/index.php?m=&c=Wechat&a=index&menuid=44';
	var ROOT_PATH = '/tp';
            ...
            <div class="J_tablelist table_list">
                <table width="100%" cellspacing="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center"><?php echo ($val["app_secret"]); ?></td>
                            <td align="center"><?php echo ($val["token"]); ?></td>
                        <td align="center">
                            <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('Wechat/edit',array('id'=>$val['id']));?>" data-title="<?php echo L('edit');?> - <?php echo ($val['site_name']); ?>" data-id="edit" data-width="500" data-height="350"><?php echo L('edit');?></a> |
                            <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('Wechat/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['site_name']);?>"><?php echo L('delete');?></a>
                        </td>
