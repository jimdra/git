...
<head>
	...
	var SELF = 'http://admin.leishenhuyu.com/index.php?m=&c=Slide&a=index&menuid=28';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10">
            ...
            <div class="J_tablelist table_list">
                <table width="100%" cellspacing="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center"><?php echo ($val["width"]); ?></td>
                            <td align="center"><?php echo ($val["height"]); ?></td>
                            <td align="center">
                                <a href="<?php echo U('Slide/picmanage',array('slide_id'=>$val['id']));?>"><?php echo L('picmanage');?></a> |
                                <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('Slide/edit',array('id'=>$val['id']));?>" data-title="<?php echo L('edit');?> - <?php echo ($val['name']); ?>" data-id="edit" data-width="400" data-height="200"><?php echo L('edit');?></a> |
                                <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('Slide/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['name']);?>"><?php echo L('delete');?></a>
                            </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('Slide/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
