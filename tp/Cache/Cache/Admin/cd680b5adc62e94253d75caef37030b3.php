...
<head>
	...
	var SELF = 'http://admin.leishenhuyu.com/index.php?m=&c=Land&a=index&menuid=38';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10">
                    ...
                    <td>
                        <div class="explain_col">
                            ...
                            <select name="searchtype">
                                <option value="id" <?php if(($searchtype) == "id"): ?>selected="selected"<?php endif; ?>><?php echo L('ID');?></option>
                                <option value="land_title" <?php if(($search["searchtype"]) == "land_title"): ?>selected="selected"<?php endif; ?>><?php echo L('land_title');?></option>
                            </select>
                            ...
                            <input type="button" class="btn J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('Land/recreate');?>" data-title="<?php echo L('recreate');?>" data-id="recreate" data-width="450" data-height="200" data-msg="确认<?php echo L('recreate');?>吗" value="<?php echo L('recreate');?>" />
                        </div>
                    </td>
                </tr>
            </tbody>
    ...
    <div class="textbox">
        <div class="picbox" role="table">
            <div class="J_tablelist table_list" data-acturi="<?php echo U('Land/ajax_edit');?>">
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="40"><input type="checkbox" name="checkall" class="J_checkall"></th>
                            <th width="40">ID</th>
                            <th><?php echo L('land_title');?></th>
                            <th><?php echo L('game_name');?></th>
                            <th><?php echo L('title');?></th>
                            <th><?php echo L('land_url');?></th>
                            <th><?php echo L('addtime');?></th>
                            <th><?php echo L('adduser');?></th>
                            <th width=130><?php echo L('operations_manage');?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center"><?php echo ($val["land_title"]); ?></td>
                            <td align="center"><?php echo ($val["game_name"]); ?></td>
                            <td align="center"><?php echo ($val["title"]); ?></td>
                            <td align="center"><a href='<?php echo ($val["land_url"]); ?>' target="_blank"><?php echo ($val["land_url"]); ?></a></td>
                            <td align="center"><?php echo (date('Y-m-d',$val["addtime"])); ?></td>
                            <td align="center"><?php echo ($val["adduser"]); ?></td>
                        <td align="center">
                            <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('Land/copy', array('id'=>$val['id']));?>" data-msg="确认<?php echo L('copy');?>吗"><?php echo L('copy');?></a> |
                            <a href="<?php echo U('Land/edit',array('id'=>$val['id'],'menuid'=>$menuid));?>"><?php echo L('edit');?></a> |
                            <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('Land/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['id']);?>"><?php echo L('delete');?></a>
                        </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('Land/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
