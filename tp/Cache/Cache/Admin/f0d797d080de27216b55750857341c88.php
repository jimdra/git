...
<head>
	...
	var SELF = '/index.php?m=&c=Goods&a=record&menuid=27';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
        ...
        <table width="100%" cellspacing="0" id="scl_tt2" style="height:500px;">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'title',width:150,align:'center'"><?php echo L('mail_title');?></th>
                    <th data-options="field:'content',width:150,align:'center'"><?php echo L('mail_content');?></th>
                    <th data-options="field:'attachment_str',width:200,align:'center'"><?php echo L('attachment');?></th>
                    <th data-options="field:'operation_time',width:150,align:'center'"><?php echo L('operation_time');?></th>
                    <th data-options="field:'operation_user',width:80,align:'center'"><?php echo L('operation_user');?></th>
                    <th data-options="field:'player',width:80,align:'center'"><?php echo L('player');?></th>
                    <th data-options="field:'reason',width:150,align:'center'"><?php echo L('reason');?></th>
                    ...
                    <th data-options="field:'status_str',width:150,align:'center'"><?php echo L('status');?></th>
...
function formatOper(val,row,index){
    var html = '';
    if(row.status==1){
        html += '<a href="javascript:;" onclick="confirmUrl(this);"  data-uri="index.php?m=Admin&c=Goods&a=reject&id='+row.id+'" data-title="'+row.title+'"  data-id="edit" data-msg="确认驳回"><?php echo L('reject');?></a> |';
        html += '<a href="javascript:;" onclick="confirmUrl(this);"  data-uri="index.php?m=Admin&c=Goods&a=review&id='+row.id+'" data-title="'+row.title+'"  data-id="edit" data-msg="确认审核发送"><?php echo L('review');?></a> ';
    }
    return html;
}
