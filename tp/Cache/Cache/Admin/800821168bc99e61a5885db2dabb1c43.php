...
<head>
	...
	<script>
	var URL = '/index.php/Admin/Theme';
	var SELF = 'http://admin.leishenhuyu.com/index.php?m=&c=Theme&a=index&menuid=61';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10">
    ...
    <div class="textbox">
        <div class="picbox" role="table">
            <div class="J_tablelist table_list" data-acturi="<?php echo U('Theme/ajax_edit');?>">
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="40"><input type="checkbox" name="checkall" class="J_checkall"></th>
                            <th width="40"><?php echo L('theme_id');?></th>
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            <td align="center"><input type="checkbox" class="J_checkitem" value="<?php echo ($val["theme_id"]); ?>"></td>
                            <td align="center"><?php echo ($val["theme_id"]); ?></td>
                            <td align="center"><?php echo ($val["theme_name"]); ?></td>
                            <td align="center"><?php echo ($val["theme_code"]); ?></td>
                            <td align="center"><?php echo ($val["material_num"]); ?></td>
                        <td align="center">
                            <a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('Theme/edit', array('theme_id'=>$val['theme_id'],'menuid'=>$menuid));?>" data-title="<?php echo L('edit');?> - <?php echo ($val['theme_name']); ?>" data-id="edit" data-width="400" data-height="200"><?php echo L('edit');?></a> |
                            <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('Theme/delete', array('theme_id'=>$val['theme_id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['theme_name']);?>"><?php echo L('delete');?></a>
                        </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('Theme/delete');?>" data-name="theme_id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
