...
<head>
	...
	var SELF = '/index.php?m=&c=Recharge&a=no_sell&menuid=49';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10">
                ...
                <tr>
                    <td>
                        <div class="explain_col">
                            ...
                            &nbsp;&nbsp;<?php echo L('order_code');?>
                            <input type="text" name="order_code" id="order_code"  style="width:155px;height:20px;">
                            <br/><br/>&nbsp;&nbsp;
                            <?php echo L('pay_time');?>:
    ...
    <div class="J_tablelist table_list">
        <table width="100%" cellspacing="0" id="scl_tt2" style="height:500px;">
            <thead>
                <tr>
                    <th data-options="field:'order_uuid',width:150,align:'center'"><?php echo L('order_code');?></th>
                    ...
                    <th data-options="field:'create_time',width:80,align:'center'"><?php echo L('pay_time');?></th>
                    <th data-options="field:'gold',width:80,align:'center'"><?php echo L('pay_money');?></th>
                    <th data-options="field:'content',width:150,align:'center'"><?php echo L('pay_way');?></th>
                    <th data-options="field:'opt',width:150,align:'center',formatter:formatOper">操作</th>
                </tr>
            </thead>
        </table>
    </div>
...
$(function(){
    ...
    $('#scl_tt2').datagrid({
            ...
            showFooter: true,
            nowrap:true,
            url:'<?php echo U("Recharge/no_sell");?>',
            fitColumns:true,
            nowrap:true,
            pagination:true,  //分页
            pageSize: 100,
...
function formatOper(val,row,index){
    var html = '';
    html += '<a href="javascript:;" onclick="confirmUrl(this);"  data-uri="index.php?m=Admin&c=Recharge&a=fill&platform_id='+row.platform_id+'&order_code='+row.order_uuid+'" data-title="'+row.order_uuid+'"  data-id="edit" data-msg="确认补单">补单</a>';
    return html;
}
