...
<head>
	...
	var SELF = 'http://admin.leishenhuyu.com/index.php?m=&c=Site&a=index&menuid=20';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10">
                ...
                <tr>
                    <td>
                        <div class="explain_col">
                            <input type="hidden" name="m" value="Web" />
                            <input type="hidden" name="c" value="Site" />
                            <input type="hidden" name="a" value="index" />
                            <input type="hidden" name="menuid" value="<?php echo ($menuid); ?>" />
                            &nbsp;&nbsp;<?php echo L('site_name');?> :
                            <input type="text" name="site_name" id="site_name" value="<?php echo ($search["site_name"]); ?>" style="width:155px;height:20px;">
                            &nbsp;&nbsp;<?php echo L('site_code');?> :
                            <input type="text" name="site_code" id="site_code" value="<?php echo ($search["site_code"]); ?>" style="width:155px;height:20px;">
    ...
    <div class="textbox">
        <div class="picbox" role="table">
            <div class="J_tablelist table_list" data-acturi="<?php echo U('Site/ajax_edit');?>">
                <table width="100%" cellspacing="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            <td align="center"><input type="checkbox" class="J_checkitem" value="<?php echo ($val["site_id"]); ?>"></td>
                            <td align="center"><?php echo ($val["site_id"]); ?></td>
                            <td align="center"><?php echo ($val["site_name"]); ?></td>
                            <td align="center"><?php echo ($val["site_code"]); ?></td>
                            <td align="center"><?php echo ($val["site_url"]); ?></td>
                            <td align="center"><?php if($val["status"] == 1): echo L('yes'); else: echo L('no'); endif; ?></td>
                        <td align="center">
                            <a href="<?php echo U('Site/edit', array('site_id'=>$val['site_id'],'menuid'=>$menuid));?>"><?php echo L('edit');?></a> |
                            <a href="javascript:;" class="J_confirmurl" data-uri="<?php echo U('Site/delete', array('site_id'=>$val['site_id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['site_name']);?>"><?php echo L('delete');?></a>
                        </td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('Site/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
