...
;(function($) {
    ...
    $.TP.photo_slide = function() {
        ...
        if (! (f != 1 && f < 4)) {
            ...
            if (!$.TP.util.empty(a) && !$.TP.util.empty(a.listID) && !$.TP.util.empty(a.listBtnID) && !$.TP.util.empty(a.feedClassName) && !$.TP.util.empty(a.feedWidth) && $("#" + a.listID).size() != 0) {
                var e = 0,
                d = 1,
                j = null,
                h = [],
                g = null,
                g = $.TP.util.empty(a.feedBoxClass) ? $("#" + a.listID + " ul") : $("#" + a.listID + " ." + a.feedBoxClass),
                k = function() {
    ...
    $.fn.uploader = function(options) {
        var settings = {
            ...
            showMessage: function(message){
                $.TP.tip({content:message, icon:'error'});
            },
